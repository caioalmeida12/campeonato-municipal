...
const Responsaveis = () => {
    const [data, setData] = useState<ResponsavelType[]>([])
    ...
    useEffect(() => {
        const fetchData = async () => {
            handleGet<ResponsavelType>("responsaveis")
                .then((response) => {
    ...
    const handleCreateButton = async (event: FormEvent<HTMLFormElement>) => {
        ...
        handleCreate<ResponsavelType>("responsaveis", formValues)
            .then((response) => {
    ...
    const handleDeleteButton = (id: string) => {
        try {
            ...
            handleDelete("responsaveis", id, shouldRefetch, setShouldRefetch)
                .then((response) => {
    ...
    return (
        <Structure headerText="Controle de responsáveis">
            <FormDialog
                buttonText="Adicionar responsável"
                title={"Adicionar responsável"}
                content={"Insira os dados do responsável"}
